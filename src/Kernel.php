...
class Kernel extends BaseKernel
{
    ...
    private const CONFIG_EXT = '.{php,xml,yaml,yml}';
    ...
    protected function configureContainer(ContainerBuilder $container, LoaderInterface $loader): void
    {
        ...
        $loader->load($confDir.'/{parameters}'.self::CONFIG_EXT, 'glob');
    ...
    protected function configureRoutes(RouteCollectionBuilder $routes): void
    {
        ...
        $routes->import($confDir.'/{routes}/*'.self::CONFIG_EXT, '/', 'glob');
        $routes->import($confDir.'/{routes}/'.$this->environment.'/**/*'.self::CONFIG_EXT, '/', 'glob');
        $routes->import($confDir.'/{routes}'.self::CONFIG_EXT, '/', 'glob');
    }
}
